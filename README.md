...
Jupyter notebook tutorials for [patpy](https://github.com/lueckenlab/patpy).
...
- `immune_aging_multiresolution_composition.ipynb` — Immune Health Atlas: CLR composition vs pseudobulk methods across AIFI L1–L3 with a SPARE-style KNN benchmark (biological vs technical covariates).

## Editing tutorials

See the [contributing guide in patpy](https://github.com/lueckenlab/patpy/blob/main/docs/contributing.md) for the submodule workflow.
